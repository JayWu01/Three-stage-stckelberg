...
# alpha, beta, zeta = np.array([3.0, 3.0, 3.0]), np.array([5.0, 5.0, 5.0]), np.array([0.5, 0.5, 0.5])
...
if __name__ == '__main__':
    ...
    # for index, vumber in enumerate(n_vechicle):
    for index, item in enumerate(Budget):
        ...
        print("已达到纳什均衡")
    print("--------------------------P_0_v,P_1_v,P_2_v,p_j_vop_v-------------------", P_0_v, ',', P_1_v, ',', P_2_v,
          ',', p_j_vop_v)
    print("--------------------------F_0_v,F_1_v,F_2_v,f_j_vop_v-------------------", F_0_v, ',', F_1_v, ',', F_2_v,
          ',', F_j_vop_v)
